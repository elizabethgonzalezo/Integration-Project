...
print(
    "-" * 150)  # Source- Samantha Walsh, helped me include a string operator of multiplication into my program. Which is used to multiply a string to another data type, in this example, it's being multiplied to an integer.
print(
    "Hi there! Welcome to the world of fashion, today I'll be your guide as you discover new styles. Let's get started!")
sleep_time(1)
print("First, tell us a little bit about yourself!")
print(
    "Read the following statements, and then choose the one which best defines you.")
...
options_def_user = [first_choice, second_choice, third_choice, fourth_choice,
                    fifth_choice]
...
while (still_looping):
    ...
    if users_choice == "a":
        print(
            "Based on your answer, I'd recommend you look into the Model Off Duty aesthetic.")
        still_looping = False
    elif users_choice == "b":
        print(
            "Based on your answer, I'd recommend you look into the Streetwear aesthetic.")
        still_looping = False
    elif users_choice == "c":
        print(
            "Based on your answer, I'd recommend you look into the Soft Girl aesthetic.")
        still_looping = False
    elif users_choice == "d":
        print(
            "Based on your answer, I'd recommend you look into the Preppy aesthetic.")
        still_looping = False
    elif users_choice == "e":
        print(
            "Based on your answer, I'd recommend you look into the Rocker Chic.")
        still_looping = False
    else:
...
sleep_time(1.5)
print(
    "You now have the option to continue with the recommendation provided to you, or choose a different aesthetic from the ones listed below.")
options_for_aesthetics = ["Preppy", "Soft Girl", "Rocker Chic", "Streetwear",
                          "Model Off Duty"]
...
def preppy_fit():
    ...
    sleep_time(1)
    print(
        "Loafers, white socks, tennis skirt, white button up with a crewneck, and gold accessories.")
    sleep_time(1)
    print(
        "Loafers, blazer, plaid skirt, white button up, and a pearl necklace.")
...
def rocker_chic_fit():
    ...
    sleep_time(1)
    print(
        "Black boots, black mini skirt, baby tee, sunglasses, shoulder bag, and silver jewelry.")
    sleep_time(1)
    print(
        "Platform heels, black tennis skirt, dark-colored crewneck, white button-up, and a shoulder bag.")
...
def streetwear_fit():
    ...
    sleep_time(1)
    print(
        "Nike Dunks, denim shorts, neutral crop top, trucker hat, and a tote bag.")
    sleep_time(1)
    print(
        "Jordan 1s, oversized t-shirt, mom jeans, shoulder bag, and gold jewelry.")
...
def model_off_duty_fit():
    ...
    sleep_time(1)
    print(
        "New balance, parachute pants, cropped white tank top, cross-body bag, sunglasses, and silver jewelry.")
    sleep_time(1)
    print(
        "White sneakers, black mom jeans, neutral long sleeve, shoulder bag, and a claw-clip.")


keep_looping = True
while (keep_looping):
    aesthetic_chosen_by_user = input(
        "Please type in your choice, exactly as it is written above:")
...
print(both_steps,
      end=".")  # why does this line go with the one below it, come back to this
print(
    "In order to recommend stores in which you can find your outfits, it's helpful to know your budget.")
users_budget = float(input(
    "Enter the maximum amount you'd pay for a complete outfit, including accessories:"))
if (users_budget > 50.00) and (users_budget <= 100.00):
    ...
    sleep_time(1)
    print(
        "Stores you can shop at include: Neiman Marcus, Saks 5th Avenue, Nordstrom")

print(
    "Once you've got a store in mind, here's what the average outfit within a specific aesthetic can cost.")
...
sleep_time(1.25)
print(
    "Clearly, it requires some money to keep up with the expensive lifestyle of a fashionista.")
sleep_time(1.25)
print(
    "Here are the aesthetics in order of least expensive to most expensive, from top to bottom.")
cost_of_outfits_from_low_to_high = ["Preppy", "Model Off Duty", "Streetwear",
                                    "Soft Girl",
                                    "Rocker Chic"]  # Once again, taking what I learned from w3schools, "Python For Loops," to list the outfits from least to most expensive. Link https://www.w3schools.com/python/python_for_loops.asp
for outfit_organizate in cost_of_outfits_from_low_to_high:
    print(outfit_organizate)
print("-" * 150)
print(
    "However, because you're our favorite, we'll go ahead an give you a 20% discount on all the outfits!")
...
print(
    math_example1 / continuation_math_example1)  # The  / operator represents division, commonly used in arithmetic problems.

print(
    20 % 6)  # The modulus operator tells us what's left over or the remainder left from dividing the two numbers. I remember going over these operators in class, that's where I got this information from.
print(
    11 // 3)  # The // tells us how many times a number can go into the number it is being divided completely.
counter_example = 5
